...
#define INITIAL_BLOCK_MAX_STIMULATE_TIME 1
...
#define VERILATOR_MAIN_FOREVER_BLOCK()                               \
    ...
    {                                                                \
        T_start = T;                                                 \
            ...
            VERILATOR_SWITCH_INPUT_TO(a, 1); \
            VERILATOR_SWITCH_INPUT_TO(b, 1); \
            VERILATOR_STEP_AND_EVAL_UNTIL(1 + T_start); \
            VERILATOR_SWITCH_INPUT_TO(a, 0); \
            VERILATOR_STEP_AND_EVAL_UNTIL(2 + T_start); \
            VERILATOR_SWITCH_INPUT_TO(b, 0); \
            VERILATOR_STEP_AND_EVAL_UNTIL(3 + T_start); \
            VERILATOR_SWITCH_INPUT_TO(a, 1); \
